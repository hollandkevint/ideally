...
export default function AccountPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      // Note: In a production app, you'd want to delete user data first
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-secondary">
                  {workspaceState?.chat_context.length || 0} messages, 
                  {workspaceState?.canvas_elements.length || 0} elements
                </span>
              </div>
            </div>
          </div>
