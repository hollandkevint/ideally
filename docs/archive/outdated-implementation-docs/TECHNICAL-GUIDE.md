# thinkhaven Technical Guide - Master Reference
...
**Current Reality:** thinkhaven is a sophisticated Next.js 15 application with working authentication, comprehensive database schema, and dual-pane interface foundation. The critical gap is the absence of actual Claude Sonnet 4 integration - current "Mary" AI responses are hardcoded simulations requiring replacement with real AI capabilities.
...
**Location:** `/Users/kthkellogg/Documents/GitHub/thinkhaven/apps/web/app/workspace/[id]/page.tsx`
...
#### **MISSING: API Routes**
**Location:** Need to create `/Users/kthkellogg/Documents/GitHub/thinkhaven/apps/web/app/api/`
...
**Location:** Need to create `/Users/kthkellogg/Documents/GitHub/thinkhaven/apps/web/lib/ai/`
...
**File:** `/Users/kthkellogg/Documents/GitHub/thinkhaven/apps/web/.env.local`
```bash
...
**This technical guide serves as the master reference for all development work on the thinkhaven platform. It reflects the current implementation reality and provides clear guidance for the Claude Sonnet 4 integration enhancement.**
