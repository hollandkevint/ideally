  ...
  return (
    <div className={`relative ${className}`}>
      <textarea
        ...
        className="w-full h-64 p-4 font-mono text-sm border border-gray-200 rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50"
