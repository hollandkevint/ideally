      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-6">
        ...
        <div className="space-y-4">
          {questions.map((question, index) => (
            <div
              key={index}
              className={`group rounded-lg border border-blue-200 bg-white p-4 transition-all ${
                onQuestionClick
                  ? 'cursor-pointer hover:border-blue-300 hover:shadow-md hover:-translate-y-0.5'
                  : ''
              }`}
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-gray-800 leading-relaxed group-hover:text-blue-900 transition-colors">
                    {question}
                  </p>
                  {onQuestionClick && (
